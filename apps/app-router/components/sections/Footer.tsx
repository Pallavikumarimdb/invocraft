      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-8 border-t border-border pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            <Link href="#" className=" text-[#8f9eb2] hover:text-foreground transition-colors">
          ...
          <p className="mt-8  text-[#8f9eb2] text-muted-foreground md:mt-0 md:order-1">
            &copy; 2025 InvoCraft, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
